...
public class NuevoProductoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PedidoProducto pp = new PedidoProducto(p.getPedidoId(), producto.getProductoId());
        
       // pp.setCantidad(Short.parseShort(Integer.toString(updateC)));
        ...
        //Añado el pedidoproducto a la lista de pedidoproducto del pedido anterior
